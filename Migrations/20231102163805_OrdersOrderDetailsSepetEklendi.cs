...
{
    public partial class OrdersOrderDetailsSepetEklendi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sepets", x => x.RecordId);
                    table.ForeignKey(
                        name: "FK_Sepets_Albums_AlbumId",
                        column: x => x.AlbumId,
